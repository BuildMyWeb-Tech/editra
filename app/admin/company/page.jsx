...
export default function AdminStores() {
    ...
    return !loading ? (
        <div className="text-slate-500 mb-28">
            <h1 className="text-2xl">All <span className="text-slate-800 font-medium">Company</span></h1>
            ...
            {stores.length ? (
                ...
                <div className="flex items-center justify-center h-80">
                    <h1 className="text-3xl text-slate-400 font-medium">No Company Available</h1>
                </div>
            )
            }
        </div>
